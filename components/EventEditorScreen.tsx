...
export type EventEditorSubmitInput = CreateEventValues & {
  groupId: string;
  photos: SelectedImage[];
};

type EventEditorScreenProps = {
  title: string;
  initialValues: CreateEventValues;
  initialPhotos?: SelectedImage[];
  onSubmit: (input: EventEditorSubmitInput) => Promise<unknown>;
};
